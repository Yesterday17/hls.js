...
(function (global, factory) {
  ...
  var AACDemuxer = /*#__PURE__*/function (_BaseAudioDemuxer) {
    ...
    _proto.demuxSampleAes = /*#__PURE__*/function () {
      var _demuxSampleAes = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, keyData, timeOffset) {
        var demuxResult, sampleAes;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              demuxResult = this.demux(data, timeOffset);
              sampleAes = this.sampleAes = new SampleAesDecrypter(this.observer, this.config, keyData);
              return _context.a(2, new Promise(function (resolve) {
                sampleAes.decryptAacSamples(demuxResult.audioTrack.samples, 0, function () {
                  resolve(demuxResult);
                });
              }));
          }
      ...
      function demuxSampleAes(_x, _x2, _x3) {
        return _demuxSampleAes.apply(this, arguments);
      }
      return demuxSampleAes;
    }();
    return AACDemuxer;
  }(BaseAudioDemuxer);
